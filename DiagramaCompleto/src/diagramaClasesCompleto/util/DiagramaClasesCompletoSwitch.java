	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DiagramaClasesCompletoPackage.CLASE: {
				...
				if (result == null) result = caseClasificador(clase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramaClasesCompletoPackage.INTERFACE: {
				...
				if (result == null) result = caseClasificador(interface_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DiagramaClasesCompletoPackage.OPERACION: {
				...
				if (result == null) result = caseRetornable(operacion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DiagramaClasesCompletoPackage.ATRIBUTO: {
				...
				if (result == null) result = caseRetornable(atributo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
