...
public enum TipoABM implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TipoABM[] VALUES_ARRAY =
		new TipoABM[] {
			SIMPLE,
			SELECCIONABLE,
			MAESTRO_DETALLE,
			MAESTRO_COMBO_DETALLE,
			MAESTRO_DETALLE_COMBO,
			MAESTRO_COMBO_DETALLE_COMBO,
			SIN_REPRESENTACION,
		};
	...
	public static TipoABM get(int value) {
		switch (value) {
			...
			case SELECCIONABLE_VALUE: return SELECCIONABLE;
			case MAESTRO_DETALLE_VALUE: return MAESTRO_DETALLE;
			case MAESTRO_DETALLE_COMBO_VALUE: return MAESTRO_DETALLE_COMBO;
			case MAESTRO_COMBO_DETALLE_COMBO_VALUE: return MAESTRO_COMBO_DETALLE_COMBO;
			case SIN_REPRESENTACION_VALUE: return SIN_REPRESENTACION;
		}
		return null;
	}
