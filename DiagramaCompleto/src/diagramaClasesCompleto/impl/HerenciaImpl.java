...
public class HerenciaImpl extends MinimalEObjectImpl.Container implements Herencia {
		...
		if (origen != null && origen.eIsProxy()) {
			...
			if (origen != oldOrigen) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.HERENCIA__ORIGEN, oldOrigen, origen));
			}
		}
		return origen;
	}
	...
	public void setOrigen(Clasificador newOrigen) {
		...
		origen = newOrigen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.HERENCIA__ORIGEN, oldOrigen, origen));
	}
	...
	public Clasificador getDestino() {
		if (destino != null && destino.eIsProxy()) {
			...
			if (destino != oldDestino) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.HERENCIA__DESTINO, oldDestino, destino));
			}
		}
		return destino;
	}
	...
	public void setDestino(Clasificador newDestino) {
		...
		destino = newDestino;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.HERENCIA__DESTINO, oldDestino, destino));
	}
