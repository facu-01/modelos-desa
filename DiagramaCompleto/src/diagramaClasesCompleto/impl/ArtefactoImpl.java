...
public class ArtefactoImpl extends MinimalEObjectImpl.Container implements Artefacto {
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__NOMBRE, oldNombre, nombre));
	}
	...
	public void setGrupoId(String newGrupoId) {
		...
		grupoId = newGrupoId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__GRUPO_ID, oldGrupoId, grupoId));
	}
	...
	public void setArtefactotId(String newArtefactotId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__ARTEFACTOT_ID, oldArtefactotId, artefactotId));
	}
	...
	public void setDescripcion(String newDescripcion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__DESCRIPCION, oldDescripcion, descripcion));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ARTEFACTO__VERSION, oldVersion, version));
	}
