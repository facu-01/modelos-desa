...
public class ClaseImpl extends ClasificadorImpl implements Clase {
	...
	public EList<Relacion> getRelaciones_contenidas() {
		if (relaciones_contenidas == null) {
			relaciones_contenidas = new EObjectContainmentEList<Relacion>(Relacion.class, this, DiagramaClasesCompletoPackage.CLASE__RELACIONES_CONTENIDAS);
		}
	...
	public void setEsAbstracta(boolean newEsAbstracta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CLASE__ES_ABSTRACTA, oldEsAbstracta, esAbstracta));
	}
	...
	public EList<Realizacion> getRealizaciones_contenidas() {
		if (realizaciones_contenidas == null) {
			realizaciones_contenidas = new EObjectContainmentEList<Realizacion>(Realizacion.class, this, DiagramaClasesCompletoPackage.CLASE__REALIZACIONES_CONTENIDAS);
		}
	...
	public void setEsAsociativa(boolean newEsAsociativa) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CLASE__ES_ASOCIATIVA, oldEsAsociativa, esAsociativa));
	}
	...
	public void setEsAuditable(boolean newEsAuditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CLASE__ES_AUDITABLE, oldEsAuditable, esAuditable));
	}
	...
	public void setTieneABM(boolean newTieneABM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CLASE__TIENE_ABM, oldTieneABM, tieneABM));
	}
