...
public class AtributoImpl extends RetornableImpl implements Atributo {
	...
	public void setTipo(TipoDato newTipo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ATRIBUTO__TIPO, oldTipo, tipo));
	}
	...
	public void setEsAuditable(boolean newEsAuditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ATRIBUTO__ES_AUDITABLE, oldEsAuditable, esAuditable));
	}
	...
	public void setPseudonimo(String newPseudonimo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ATRIBUTO__PSEUDONIMO, oldPseudonimo, pseudonimo));
	}
	...
	public void setRepresentacionGrafica(RepresentacionGrafica newRepresentacionGrafica) {
		...
		representacionGrafica = newRepresentacionGrafica == null ? REPRESENTACION_GRAFICA_EDEFAULT : newRepresentacionGrafica;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.ATRIBUTO__REPRESENTACION_GRAFICA, oldRepresentacionGrafica, representacionGrafica));
	}
