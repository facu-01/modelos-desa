...
public abstract class RetornableImpl extends MinimalEObjectImpl.Container implements Retornable {
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RETORNABLE__NOMBRE, oldNombre, nombre));
	}
	...
	public void setVisibilidad(ModicadoresAcceso newVisibilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RETORNABLE__VISIBILIDAD, oldVisibilidad, visibilidad));
	}
	...
	public void setEsFinal(boolean newEsFinal) {
		...
		esFinal = newEsFinal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RETORNABLE__ES_FINAL, oldEsFinal, esFinal));
	}
	...
	public void setEsStatic(boolean newEsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RETORNABLE__ES_STATIC, oldEsStatic, esStatic));
	}
