...
public class DiagramaClasesImpl extends MinimalEObjectImpl.Container implements DiagramaClases {
	...
	public EList<diagramaClasesCompleto.Package> getPackages_contenidos() {
		if (packages_contenidos == null) {
			packages_contenidos = new EObjectContainmentEList<diagramaClasesCompleto.Package>(diagramaClasesCompleto.Package.class, this, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__PACKAGES_CONTENIDOS);
		}
	...
	public NotificationChain basicSetArtefacto_contenido(Artefacto newArtefacto_contenido, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__ARTEFACTO_CONTENIDO, oldArtefacto_contenido, newArtefacto_contenido);
	...
	public void setArtefacto_contenido(Artefacto newArtefacto_contenido) {
		if (newArtefacto_contenido != artefacto_contenido) {
			...
			if (artefacto_contenido != null)
				msgs = ((InternalEObject)artefacto_contenido).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__ARTEFACTO_CONTENIDO, null, msgs);
			if (newArtefacto_contenido != null)
				msgs = ((InternalEObject)newArtefacto_contenido).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__ARTEFACTO_CONTENIDO, null, msgs);
			msgs = basicSetArtefacto_contenido(newArtefacto_contenido, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__ARTEFACTO_CONTENIDO, newArtefacto_contenido, newArtefacto_contenido));
	}
	...
	public NotificationChain basicSetConfiguraciondb(ConfiguracionDB newConfiguraciondb, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDB, oldConfiguraciondb, newConfiguraciondb);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfiguraciondb(ConfiguracionDB newConfiguraciondb) {
		if (newConfiguraciondb != configuraciondb) {
			...
			if (configuraciondb != null)
				msgs = ((InternalEObject)configuraciondb).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDB, null, msgs);
			if (newConfiguraciondb != null)
				msgs = ((InternalEObject)newConfiguraciondb).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDB, null, msgs);
			msgs = basicSetConfiguraciondb(newConfiguraciondb, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDB, newConfiguraciondb, newConfiguraciondb));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConfiguraciondocker(ConfiguracionDocker newConfiguraciondocker, NotificationChain msgs) {
		ConfiguracionDocker oldConfiguraciondocker = configuraciondocker;
		configuraciondocker = newConfiguraciondocker;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDOCKER, oldConfiguraciondocker, newConfiguraciondocker);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfiguraciondocker(ConfiguracionDocker newConfiguraciondocker) {
		if (newConfiguraciondocker != configuraciondocker) {
			...
			if (configuraciondocker != null)
				msgs = ((InternalEObject)configuraciondocker).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDOCKER, null, msgs);
			if (newConfiguraciondocker != null)
				msgs = ((InternalEObject)newConfiguraciondocker).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDOCKER, null, msgs);
			msgs = basicSetConfiguraciondocker(newConfiguraciondocker, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDOCKER, newConfiguraciondocker, newConfiguraciondocker));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConfiguracionlenguaje(ConfiguracionLenguaje newConfiguracionlenguaje, NotificationChain msgs) {
		ConfiguracionLenguaje oldConfiguracionlenguaje = configuracionlenguaje;
		configuracionlenguaje = newConfiguracionlenguaje;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE, oldConfiguracionlenguaje, newConfiguracionlenguaje);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfiguracionlenguaje(ConfiguracionLenguaje newConfiguracionlenguaje) {
		if (newConfiguracionlenguaje != configuracionlenguaje) {
			...
			if (configuracionlenguaje != null)
				msgs = ((InternalEObject)configuracionlenguaje).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE, null, msgs);
			if (newConfiguracionlenguaje != null)
				msgs = ((InternalEObject)newConfiguracionlenguaje).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE, null, msgs);
			msgs = basicSetConfiguracionlenguaje(newConfiguracionlenguaje, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE, newConfiguracionlenguaje, newConfiguracionlenguaje));
	}
	...
	public EList<ConfiguracionMicroservicios> getConfiguracionmicroservicios() {
		if (configuracionmicroservicios == null) {
			configuracionmicroservicios = new EObjectContainmentEList<ConfiguracionMicroservicios>(ConfiguracionMicroservicios.class, this, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONMICROSERVICIOS);
		}
