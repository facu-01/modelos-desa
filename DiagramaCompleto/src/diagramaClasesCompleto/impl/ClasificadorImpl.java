...
public abstract class ClasificadorImpl extends MinimalEObjectImpl.Container implements Clasificador {
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CLASIFICADOR__NOMBRE, oldNombre, nombre));
	}
	...
	public EList<Atributo> getAtributos_contenidos() {
		if (atributos_contenidos == null) {
			atributos_contenidos = new EObjectContainmentEList<Atributo>(Atributo.class, this, DiagramaClasesCompletoPackage.CLASIFICADOR__ATRIBUTOS_CONTENIDOS);
		}
	...
	public EList<Operacion> getOperaciones_contenidas() {
		if (operaciones_contenidas == null) {
			operaciones_contenidas = new EObjectContainmentEList<Operacion>(Operacion.class, this, DiagramaClasesCompletoPackage.CLASIFICADOR__OPERACIONES_CONTENIDAS);
		}
	...
	public EList<Herencia> getHerencias_contenidas() {
		if (herencias_contenidas == null) {
			herencias_contenidas = new EObjectContainmentEList<Herencia>(Herencia.class, this, DiagramaClasesCompletoPackage.CLASIFICADOR__HERENCIAS_CONTENIDAS);
		}
