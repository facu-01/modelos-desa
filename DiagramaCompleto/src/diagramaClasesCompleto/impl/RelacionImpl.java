...
public class RelacionImpl extends MinimalEObjectImpl.Container implements Relacion {
		...
		if (destino != null && destino.eIsProxy()) {
			...
			if (destino != oldDestino) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.RELACION__DESTINO, oldDestino, destino));
			}
		}
		return destino;
	}
	...
	public void setDestino(Clasificador newDestino) {
		...
		destino = newDestino;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__DESTINO, oldDestino, destino));
	}
	...
	public void setNombre(String newNombre) {
		...
		nombre = newNombre;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__NOMBRE, oldNombre, nombre));
	}
	...
	public void setTipo(TipoRelacion newTipo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__TIPO, oldTipo, tipo));
	}
	...
	public void setMultiplicidad(Multiplicidad newMultiplicidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__MULTIPLICIDAD, oldMultiplicidad, multiplicidad));
	}
	...
	public Clase getOrigen() {
		if (origen != null && origen.eIsProxy()) {
			...
			if (origen != oldOrigen) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.RELACION__ORIGEN, oldOrigen, origen));
			}
		}
		return origen;
	}
	...
	public void setOrigen(Clase newOrigen) {
		...
		origen = newOrigen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__ORIGEN, oldOrigen, origen));
	}
	...
	public EList<Clase> getClases_asociativas_contenidas() {
		if (clases_asociativas_contenidas == null) {
			clases_asociativas_contenidas = new EObjectContainmentEList<Clase>(Clase.class, this, DiagramaClasesCompletoPackage.RELACION__CLASES_ASOCIATIVAS_CONTENIDAS);
		}
	...
	public void setEsFinal(boolean newEsFinal) {
		...
		esFinal = newEsFinal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__ES_FINAL, oldEsFinal, esFinal));
	}
	...
	public void setEsStatic(boolean newEsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__ES_STATIC, oldEsStatic, esStatic));
	}
	...
	public void setVisibilidad(ModicadoresAcceso newVisibilidad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__VISIBILIDAD, oldVisibilidad, visibilidad));
	}
	...
	public void setTipoABM(TipoABM newTipoABM) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__TIPO_ABM, oldTipoABM, tipoABM));
	}
	...
	public void setSubordinada(boolean newSubordinada) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.RELACION__SUBORDINADA, oldSubordinada, subordinada));
	}
