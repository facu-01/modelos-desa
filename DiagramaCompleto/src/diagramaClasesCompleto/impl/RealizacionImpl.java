...
public class RealizacionImpl extends MinimalEObjectImpl.Container implements Realizacion {
		...
		if (destino != null && destino.eIsProxy()) {
			...
			if (destino != oldDestino) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.REALIZACION__DESTINO, oldDestino, destino));
			}
		}
		return destino;
	}
	...
	public void setDestino(Interface newDestino) {
		...
		destino = newDestino;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.REALIZACION__DESTINO, oldDestino, destino));
	}
	...
	public Clase getOrigen() {
		if (origen != null && origen.eIsProxy()) {
			...
			if (origen != oldOrigen) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramaClasesCompletoPackage.REALIZACION__ORIGEN, oldOrigen, origen));
			}
		}
		return origen;
	}
	...
	public void setOrigen(Clase newOrigen) {
		...
		origen = newOrigen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.REALIZACION__ORIGEN, oldOrigen, origen));
	}
