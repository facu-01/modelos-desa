 ...
 * @generated
 */
public class ConfiguracionMicroserviciosImpl extends MinimalEObjectImpl.Container implements ConfiguracionMicroservicios {
	/**
	...
	public void setIpDiscovery(String newIpDiscovery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_MICROSERVICIOS__IP_DISCOVERY, oldIpDiscovery, ipDiscovery));
	}
	...
	public void setPuertoDiscovery(int newPuertoDiscovery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_MICROSERVICIOS__PUERTO_DISCOVERY, oldPuertoDiscovery, puertoDiscovery));
	}
