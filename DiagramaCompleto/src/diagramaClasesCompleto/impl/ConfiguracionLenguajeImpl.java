...
public class ConfiguracionLenguajeImpl extends MinimalEObjectImpl.Container implements ConfiguracionLenguaje {
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_LENGUAJE__VERSION, oldVersion, version));
	}
	...
	public void setLenguaje(Lenguaje newLenguaje) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_LENGUAJE__LENGUAJE, oldLenguaje, lenguaje));
	}
