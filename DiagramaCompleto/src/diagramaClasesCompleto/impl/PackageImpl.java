...
public class PackageImpl extends MinimalEObjectImpl.Container implements diagramaClasesCompleto.Package {
	...
	public EList<Clasificador> getClasificadores_contenidos() {
		if (clasificadores_contenidos == null) {
			clasificadores_contenidos = new EObjectContainmentEList<Clasificador>(Clasificador.class, this, DiagramaClasesCompletoPackage.PACKAGE__CLASIFICADORES_CONTENIDOS);
		}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.PACKAGE__NOMBRE, oldNombre, nombre));
	}
