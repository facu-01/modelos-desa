...
public class EndPointImpl extends MinimalEObjectImpl.Container implements EndPoint {
	...
	public void setTipoVerdo(VerbosHTTP newTipoVerdo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.END_POINT__TIPO_VERDO, oldTipoVerdo, tipoVerdo));
	}
	...
	public void setTipoTransferenciaEntrada(TipoTransferencia newTipoTransferenciaEntrada) {
		...
		tipoTransferenciaEntrada = newTipoTransferenciaEntrada == null ? TIPO_TRANSFERENCIA_ENTRADA_EDEFAULT : newTipoTransferenciaEntrada;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.END_POINT__TIPO_TRANSFERENCIA_ENTRADA, oldTipoTransferenciaEntrada, tipoTransferenciaEntrada));
	}
	...
	public void setTipoTransferenciaSalida(TipoTransferencia newTipoTransferenciaSalida) {
		...
		tipoTransferenciaSalida = newTipoTransferenciaSalida == null ? TIPO_TRANSFERENCIA_SALIDA_EDEFAULT : newTipoTransferenciaSalida;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.END_POINT__TIPO_TRANSFERENCIA_SALIDA, oldTipoTransferenciaSalida, tipoTransferenciaSalida));
	}
	...
	public void setNombrePublicado(String newNombrePublicado) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.END_POINT__NOMBRE_PUBLICADO, oldNombrePublicado, nombrePublicado));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DiagramaClasesCompletoPackage.END_POINT__NOMBRE_PUBLICADO:
				return NOMBRE_PUBLICADO_EDEFAULT == null ? nombrePublicado != null : !NOMBRE_PUBLICADO_EDEFAULT.equals(nombrePublicado);
		}
