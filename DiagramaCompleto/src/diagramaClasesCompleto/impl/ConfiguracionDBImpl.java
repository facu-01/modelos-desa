...
public class ConfiguracionDBImpl extends MinimalEObjectImpl.Container implements ConfiguracionDB {
	...
	public void setDbNombre(String newDbNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__DB_NOMBRE, oldDbNombre, dbNombre));
	}
	...
	public void setDbUsuario(String newDbUsuario) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__DB_USUARIO, oldDbUsuario, dbUsuario));
	}
	...
	public void setDbPuerto(int newDbPuerto) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__DB_PUERTO, oldDbPuerto, dbPuerto));
	}
	...
	public void setIp(String newIp) {
		...
		ip = newIp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__IP, oldIp, ip));
	}
	...
	public void setDbContrasena(String newDbContrasena) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__DB_CONTRASENA, oldDbContrasena, dbContrasena));
	}
	...
	public void setServerPuerto(int newServerPuerto) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__SERVER_PUERTO, oldServerPuerto, serverPuerto));
	}
	...
	public void setTipoProveedor(ProveedorDb newTipoProveedor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DB__TIPO_PROVEEDOR, oldTipoProveedor, tipoProveedor));
	}
