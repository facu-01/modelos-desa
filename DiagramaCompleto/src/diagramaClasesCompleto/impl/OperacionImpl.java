...
public class OperacionImpl extends RetornableImpl implements Operacion {
	...
	public void setTipoRetorno(TipoRetorno newTipoRetorno) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.OPERACION__TIPO_RETORNO, oldTipoRetorno, tipoRetorno));
	}
	...
	public void setEsAbstracta(boolean newEsAbstracta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.OPERACION__ES_ABSTRACTA, oldEsAbstracta, esAbstracta));
	}
	...
	public EList<Retornable> getParametros_contenidos() {
		if (parametros_contenidos == null) {
			parametros_contenidos = new EObjectContainmentEList<Retornable>(Retornable.class, this, DiagramaClasesCompletoPackage.OPERACION__PARAMETROS_CONTENIDOS);
		}
	...
	public NotificationChain basicSetEndpoint(EndPoint newEndpoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.OPERACION__ENDPOINT, oldEndpoint, newEndpoint);
	...
	public void setEndpoint(EndPoint newEndpoint) {
		if (newEndpoint != endpoint) {
			...
			if (endpoint != null)
				msgs = ((InternalEObject)endpoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.OPERACION__ENDPOINT, null, msgs);
			if (newEndpoint != null)
				msgs = ((InternalEObject)newEndpoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DiagramaClasesCompletoPackage.OPERACION__ENDPOINT, null, msgs);
			msgs = basicSetEndpoint(newEndpoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.OPERACION__ENDPOINT, newEndpoint, newEndpoint));
	}
	...
	public EList<ParametroInterno> getParametros_internos() {
		if (parametros_internos == null) {
			parametros_internos = new EObjectContainmentEList<ParametroInterno>(ParametroInterno.class, this, DiagramaClasesCompletoPackage.OPERACION__PARAMETROS_INTERNOS);
		}
