...
public class DiagramaClasesCompletoFactoryImpl extends EFactoryImpl implements DiagramaClasesCompletoFactory {
	...
	public static DiagramaClasesCompletoFactory init() {
		try {
			DiagramaClasesCompletoFactory theDiagramaClasesCompletoFactory = (DiagramaClasesCompletoFactory)EPackage.Registry.INSTANCE.getEFactory(DiagramaClasesCompletoPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DiagramaClasesCompletoPackage.DIAGRAMA_CLASES: return createDiagramaClases();
			case DiagramaClasesCompletoPackage.CLASE: return createClase();
			case DiagramaClasesCompletoPackage.INTERFACE: return createInterface();
			case DiagramaClasesCompletoPackage.RELACION: return createRelacion();
			case DiagramaClasesCompletoPackage.OPERACION: return createOperacion();
			case DiagramaClasesCompletoPackage.ATRIBUTO: return createAtributo();
			case DiagramaClasesCompletoPackage.PACKAGE: return createPackage();
			case DiagramaClasesCompletoPackage.HERENCIA: return createHerencia();
			case DiagramaClasesCompletoPackage.REALIZACION: return createRealizacion();
			case DiagramaClasesCompletoPackage.ARTEFACTO: return createArtefacto();
			case DiagramaClasesCompletoPackage.END_POINT: return createEndPoint();
			case DiagramaClasesCompletoPackage.CONFIGURACION_DB: return createConfiguracionDB();
			case DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER: return createConfiguracionDocker();
			case DiagramaClasesCompletoPackage.CONFIGURACION_LENGUAJE: return createConfiguracionLenguaje();
			case DiagramaClasesCompletoPackage.PARAMETRO_INTERNO: return createParametroInterno();
			case DiagramaClasesCompletoPackage.CONFIGURACION_MICROSERVICIOS: return createConfiguracionMicroservicios();
			default:
