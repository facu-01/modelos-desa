...
public class ConfiguracionDockerImpl extends MinimalEObjectImpl.Container implements ConfiguracionDocker {
	...
	public void setNombreContenedor(String newNombreContenedor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__NOMBRE_CONTENEDOR, oldNombreContenedor, nombreContenedor));
	}
	...
	public void setPuertoInterior(int newPuertoInterior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__PUERTO_INTERIOR, oldPuertoInterior, puertoInterior));
	}
	...
	public void setTipoReinicio(TipoReinicio newTipoReinicio) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__TIPO_REINICIO, oldTipoReinicio, tipoReinicio));
	}
	...
	public void setNombreImagen(String newNombreImagen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__NOMBRE_IMAGEN, oldNombreImagen, nombreImagen));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__NOMBRE_CONTENEDOR:
				return NOMBRE_CONTENEDOR_EDEFAULT == null ? nombreContenedor != null : !NOMBRE_CONTENEDOR_EDEFAULT.equals(nombreContenedor);
			case DiagramaClasesCompletoPackage.CONFIGURACION_DOCKER__PUERTO_INTERIOR:
