...
public interface DiagramaClasesCompletoPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference DIAGRAMA_CLASES__CONFIGURACIONMICROSERVICIOS = eINSTANCE.getDiagramaClases_Configuracionmicroservicios();
		 ...
		 * @generated
		 */
		EAttribute CONFIGURACION_MICROSERVICIOS__PUERTO_DISCOVERY = eINSTANCE.getConfiguracionMicroservicios_PuertoDiscovery();
